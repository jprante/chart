...
import org.xbib.graphics.chart.internal.series.MarkerSeries;
        ...
        for (S series : map.values()) {
            ...
            if (series.getLegendRenderType() == LegendRenderType.Line ||
                ...
                if (series.getLegendRenderType() != LegendRenderType.BoxNoOutline) {
                    ...
                    BasicStroke newLineStyle = new BasicStroke(existingLineStyle.getLineWidth() > BOX_OUTLINE_WIDTH * 0.5f
